...
import envs
import algorithms.bptt_modified as bptt
import os
import sys
import yaml
import torch
...
def get_args(): # TODO: delve into the arguments
    custom_parameters = [
        ...
        {"name": "--cfg", "type": str, "default": "./cfg/bptt/ant.yaml",
        ...
        {"name": "--logdir", "type": str, "default": "/logs/ant_bptt_1/"},
        ...
        {"name": "--render", "action": "store_true", "default": True,
